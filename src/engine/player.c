...
/*   Updated: 2020/03/02 09:25:55 by mrouabeh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (layout->map[(int)(player->pos_y)][(int)(player->pos_x + player->dir_x * player->mov_speed)] == 0)
		set_position(player, player->dir_x * player->mov_speed, 0);
	if (layout->map[(int)(player->pos_y + player->dir_y * player->mov_speed)][(int)(player->pos_x)] == 0)
...
{
	if (layout->map[(int)(player->pos_y)][(int)(player->pos_x + player->plan_x * player->mov_speed)] == 0)
		set_position(player, player->plan_x * player->mov_speed, 0);
	if (layout->map[(int)(player->pos_y + player->plan_y * player->mov_speed)][(int)(player->pos_x)] == 0)
